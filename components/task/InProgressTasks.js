...
const {myInprogressTasks, getMyInprogressTasks, deleteTask, updateTaskStatus} = useAppContext()
...
<ul className='space-y-4'>
    {myInprogressTasks.length === 0 ? <p className='p-2 text-red-400 text-center'>Empty!!!</p>: myInprogressTasks && myInprogressTasks.map(task => 
